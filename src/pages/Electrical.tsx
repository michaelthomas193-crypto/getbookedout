...
const Electrical = () => {
  ...
  return (
    <>
      <SeoHead title="AI Receptionist for Electricians | Get Booked Out" description="Never miss an electrical job. AI receptionist answers calls 24/7, qualifies leads and books work into your diary." path="/electrical" jsonLd={{"@context":"https://schema.org","@type":"Service","serviceType":"AI receptionist for electrical businesses","provider":{"@type":"Organization","name":"Get Booked Out","url":"https://www.getbookedout.com.au"},"areaServed":{"@type":"Country","name":"Australia"},"name":"AI Receptionist for Electricians | Get Booked Out","description":"Never miss an electrical job. AI receptionist answers calls 24/7, qualifies leads and books work into your diary."}} />
