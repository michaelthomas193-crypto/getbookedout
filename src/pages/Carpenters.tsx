...
import heroCarpenter from "@/assets/hero-carpenter.webp";
...
const Carpenters = () => {
  ...
  const painPoints = [
    {
      ...
      description: "85% of missed calls never call back. They've already called another carpenter.",
  ...
  return (
    <>
      <SeoHead title="AI Receptionist for Carpenters | Get Booked Out" description="Win more carpentry work. Our AI receptionist answers calls 24/7 and books quotes into your calendar." path="/carpentry" jsonLd={{"@context":"https://schema.org","@type":"Service","serviceType":"AI receptionist for carpentry businesses","provider":{"@type":"Organization","name":"Get Booked Out","url":"https://www.getbookedout.com.au"},"areaServed":{"@type":"Country","name":"Australia"},"name":"AI Receptionist for Carpenters | Get Booked Out","description":"Win more carpentry work. Our AI receptionist answers calls 24/7 and books quotes into your calendar."}} />
      ...
      <section className="relative pt-6 pb-6 md:pt-12 md:pb-8 overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url(${heroCarpenter})` }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            ...
            <div className="text-center lg:text-left flex flex-col justify-center order-1">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-3 md:mb-4 text-foreground">
                <span className="block">Saw Running. Phone Ringing.</span>
                <span className="block" style={{ color: accentColor }}>Jobs Going to the Next Chippie.</span>
              </h1>
              
              <p className="text-base md:text-lg text-foreground mb-2 md:mb-3 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                You're in the middle of a build — sawdust everywhere, nail gun in hand. Phone rings. Can't stop. Customer calls the next chippie on Google. Sound familiar?
              </p>
        ...
        <div className="container-padding max-w-4xl mx-auto">
          <div className="text-center mb-6 md:mb-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-2 md:mb-3">
              Right now, you're <span className="text-[#8D6E63] underline decoration-2">losing jobs</span> you don't even know about.
            </h2>
            <p className="text-base md:text-lg text-muted-foreground">
              While you're on site measuring twice and cutting once...
            </p>
          </div>
