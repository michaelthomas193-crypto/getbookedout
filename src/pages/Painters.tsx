...
import heroPainting from "@/assets/hero-painting.webp";
...
const Painters = () => {
  ...
  return (
    <>
      <SeoHead title="AI Receptionist for Painters | Get Booked Out" description="Quote more painting jobs. Our AI receptionist answers calls, replies to enquiries and books in quotes 24/7." path="/painting" jsonLd={{"@context":"https://schema.org","@type":"Service","serviceType":"AI receptionist for painting businesses","provider":{"@type":"Organization","name":"Get Booked Out","url":"https://www.getbookedout.com.au"},"areaServed":{"@type":"Country","name":"Australia"},"name":"AI Receptionist for Painters | Get Booked Out","description":"Quote more painting jobs. Our AI receptionist answers calls, replies to enquiries and books in quotes 24/7."}} />
