...
const Painters = () => {
  const [heroForm, setHeroForm] = useState({ fullName: "", phone: "", businessType: "Painter" });
  const [ctaForm, setCtaForm] = useState({ fullName: "", phone: "", businessType: "Painter" });
  ...
  const handleHeroSubmit = (e: React.FormEvent) => {
    ...
    setHeroForm({ fullName: "", phone: "", businessType: "Painter" });
  };

  const handleCtaSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success("Thanks! We'll be in touch shortly.");
    setCtaForm({ fullName: "", phone: "", businessType: "Painter" });
  };
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            ...
            <div className="text-center lg:text-left flex flex-col justify-center order-1">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-3 md:mb-4 text-foreground">
                ...
                <span className="block text-[#3B9FD0]">Jobs Going to the Next Bloke.</span>
              </h1>
              ...
              <div className="bg-card rounded-2xl shadow-2xl border border-border p-5 md:p-6">
                ...
                <form onSubmit={handleHeroSubmit} className="space-y-3">
                  ...
                  <Button 
                    type="submit" 
                    size="lg" 
                    className="w-full min-h-[48px] group text-base"
        ...
        <div className="container-padding max-w-xl mx-auto">
          <div className="bg-card rounded-2xl p-6 md:p-8 border border-border shadow-lg text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">
              Stop <span className="text-[#89CFF0]">Losing Jobs</span> to Missed Calls
            </h2>
