  ...
  return (
    <>
      ...
      <div className="hidden sm:block bg-primary text-primary-foreground text-sm py-2 text-center">
        ...
        <a href="tel:0485008132" className="font-bold hover:underline">
          0485 008 132
        </a>
        ...
        <div className="container-padding max-w-7xl mx-auto">
          <div className="flex items-center justify-between h-14 md:h-16">
            ...
            <Link to="/" className="flex-shrink-0">
              <img src={logo} alt="Get Booked Out" className="h-6 md:h-8 w-auto" />
            </Link>
          ...
          <nav className="relative h-full flex flex-col pt-20 px-6 pb-8 bg-background">
            ...
            <div className="mt-auto pt-6">
              ...
              <div className="mt-6 text-center space-y-2 text-muted-foreground">
                <a href="tel:0485008132" className="block py-2 font-medium hover:text-primary">
                  0485 008 132
                </a>
